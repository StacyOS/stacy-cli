...
import * as serverUtils from "@arpanstacy/stacy-adapter-utils/server-utils";
export type { RunProcessResult } from "@arpanstacy/stacy-adapter-utils/server-utils";
...
export const buildStacyEnv = serverUtils.buildStacyEnv;
...
export function buildInvocationEnvForLogs(
  ...
  if (resolvedCommand) {
    merged[options.resolvedCommandEnvKey ?? "STACY_RESOLVED_COMMAND"] = resolvedCommand;
  }
