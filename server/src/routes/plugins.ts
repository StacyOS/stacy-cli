...
import type { ToolRunContext } from "@arpanstacy/stacy-plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@arpanstacy/stacy-plugin-sdk";
import {
  assertAuthenticated,
  assertBoard,
...
type PluginUiSlotDeclaration = NonNullable<NonNullable<StacyPluginManifestV1["ui"]>["slots"]>[number];
/** Launcher declaration extracted from plugin manifest */
type PluginLauncherDeclaration = NonNullable<StacyPluginManifestV1["launchers"]>[number];
...
interface PluginInstallRequest {
  /** npm package name (e.g., @stacy/plugin-linear) or local path */
  packageName: string;
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@arpanstacy/stacy-plugin-hello-world-example",
    pluginKey: "stacy.hello-world-example",
    displayName: "Hello World Widget (Example)",
    description: "Reference UI plugin that adds a simple Hello World widget to the Stacy dashboard.",
    localPath: "packages/plugins/examples/plugin-hello-world-example",
    tag: "example",
  },
  {
    packageName: "@arpanstacy/stacy-plugin-file-browser-example",
    pluginKey: "stacy-file-browser-example",
  ...
  {
    packageName: "@arpanstacy/stacy-plugin-kitchen-sink-example",
    pluginKey: "stacy-kitchen-sink-example",
    displayName: "Kitchen Sink (Example)",
    description: "Reference plugin that demonstrates the current Stacy plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
    localPath: "packages/plugins/examples/plugin-kitchen-sink-example",
    tag: "example",
  },
  {
    packageName: "@arpanstacy/stacy-plugin-orchestration-smoke-example",
    pluginKey: "stacy.plugin-orchestration-smoke-example",
