...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@arpanstacy/stacy-plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: StacyPluginManifestV1, pluginDbId?: string): void;
