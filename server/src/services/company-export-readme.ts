 ...
 */
import type { CompanyPortabilityManifest } from "@arpanstacy/stacy-shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Stacy](https://stacy.ing)");
  lines.push("");
