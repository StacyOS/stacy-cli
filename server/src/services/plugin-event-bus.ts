/**
 * PluginEventBus — typed in-process event bus for the Stacy plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@arpanstacy/stacy-shared";
import type { PluginEvent, EventFilter } from "@arpanstacy/stacy-plugin-sdk";
