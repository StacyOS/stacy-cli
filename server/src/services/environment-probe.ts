import type { Environment, EnvironmentProbeResult } from "@arpanstacy/stacy-shared";
import type { Db } from "@arpanstacy/stacy-db";
import { ensureSshWorkspaceReady } from "@arpanstacy/stacy-adapter-utils/ssh";
import {
...
export async function probeEnvironment(
  ...
  if (parsed.driver === "local") {
    return {
      ok: true,
      driver: "local",
      summary: "Local environment is available on this Stacy host.",
      details: {
