...
import { models as codexFallbackModels } from "@arpanstacy/stacy-adapter-codex-local";
import { models as cursorFallbackModels } from "@arpanstacy/stacy-adapter-cursor-local";
import { models as opencodeFallbackModels } from "@arpanstacy/stacy-adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@arpanstacy/stacy-adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.STACY_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.STACY_OPENCODE_COMMAND = "__stacy_missing_opencode_command__";
