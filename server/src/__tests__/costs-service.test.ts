...
import { createDb, companies, agents, costEvents, financeEvents, projects } from "@arpanstacy/stacy-db";
...
describeEmbeddedPostgres("cost and finance aggregate overflow handling", () => {
  ...
  beforeAll(async () => {
    tempDb = await startEmbeddedPostgresTestDatabase("stacy-costs-service-");
