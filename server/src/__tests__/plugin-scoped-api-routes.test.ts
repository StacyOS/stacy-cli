...
import { pluginManifestV1Schema, type StacyPluginManifestV1 } from "@arpanstacy/stacy-shared";
...
function manifest(apiRoutes: NonNullable<StacyPluginManifestV1["apiRoutes"]>): StacyPluginManifestV1 {
  return {
    id: "stacy.scoped-api-test",
    apiVersion: 1,
    version: "1.0.0",
