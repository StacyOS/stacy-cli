...
import type { Goal, Project } from "@arpanstacy/stacy-shared";
      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-border bg-background p-5">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <div className="stacy-story__label">Goal detail composition</div>
...
function GoalTreeMatrix() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <div className="rounded-lg border border-border bg-background p-4">
        <div className="stacy-story__label">Selected goal</div>
        {selectedGoal ? (
...
function WorktreeBannerMatrix() {
  setWorktreeMeta("stacy-worktree-enabled", "true");
  setWorktreeMeta("stacy-worktree-name", "PAP-1675-projects-goals-workspaces");
  setWorktreeMeta("stacy-worktree-color", "#0f766e");
  setWorktreeMeta("stacy-worktree-text-color", "#ecfeff");
  ...
  return (
    <StorybookData>
      <div className="stacy-story">
        <main className="stacy-story__inner space-y-6">
          <section className="stacy-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="stacy-story__label">Projects, goals, and workspaces</div>
