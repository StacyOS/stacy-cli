...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@arpanstacy/stacy-shared";
...
import { createIssue } from "../fixtures/stacyData";
    ...
    <div className="stacy-story">
      <main className="stacy-story__inner space-y-6">
        <section className="stacy-story__frame p-6">
          <div className="stacy-story__label">Language</div>
