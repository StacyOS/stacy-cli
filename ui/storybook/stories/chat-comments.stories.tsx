...
import type { Agent, FeedbackVote, IssueComment } from "@arpanstacy/stacy-shared";
...
import { storybookAgentMap, storybookAgents } from "../fixtures/stacyData";
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Stacy work: checkout, comments, linked runs, and review feedback.",
    ...
    <div className="stacy-story">
      <main className="stacy-story__inner space-y-6">
        <section className="stacy-story__frame p-6">
          <div className="stacy-story__label">Chat & Comments</div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Stacy operational content with mixed authors, system timeline events,
...
export const CommentThreads: Story = {
  render: () => (
    <div className="stacy-story">
      <main className="stacy-story__inner">
        <CommentThreadMatrix />
      </main>
    </div>
  ),
