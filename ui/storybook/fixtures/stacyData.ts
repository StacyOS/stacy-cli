...
const storybookRepoRoot = "~/stacy";
const storybookWorkspaceRoot = `${storybookRepoRoot}/.stacy/workspaces`;
const storybookWorktreeRoot = `${storybookRepoRoot}/.stacy/worktrees`;
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack Stacy product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    companyId: "company-storybook",
    title: "Build Stacy",
    description: "Make Stacy the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
...
const storybookWorkspaceRuntime = {
  commands: [
    ...
    },
    {
      ...
      name: "UI typecheck",
      kind: "job",
      command: "pnpm --filter @arpanstacy/stacy-ui typecheck",
      cwd: ".",
    },
  ],
};
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://stacy-docs-preview.vercel.app",
...
function createProject(overrides: Partial<Project> = {}): Project {
  ...
  return {
    ...
    codebase: {
      ...
      managedFolder: ".stacy/worktrees/storybook",
...
export const storybookContinuationHandoff: IssueDocument = {
  ...
  body: [
    ...
    "",
    "Important files: `ui/storybook/stories/issue-management.stories.tsx` and `ui/storybook/fixtures/stacyData.ts`.",
  ].join("\n"),
...
export const storybookDashboardSummary: DashboardSummary = {
  ...
  controlPlane: {
    ...
    dispatchQueue: {
      ...
      oldestLeasedAgeMs: 45_000,
    },
    riskLevel: "action",
    riskReasons: ["1 live run with cancel controls available", "1 active budget incident"],
  },
  runActivity: [
