...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@arpanstacy/stacy-shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Stacy file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Stacy storage.";
