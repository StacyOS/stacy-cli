 ...
 *
 * Plugin bundles are built with `external: ["@arpanstacy/stacy-plugin-sdk/ui", "react", "react-dom"]`,
 ...
 *    host's global bridge registry (`globalThis.__stacyPluginBridge__`)
...
function getShimBlobUrl(specifier: "react" | "react-dom" | "react-dom/client" | "react/jsx-runtime" | "sdk-ui"): string {
  ...
  switch (specifier) {
    case "react":
      source = `
        const R = globalThis.__stacyPluginBridge__?.react;
        export default R;
    ...
    case "react-dom/client":
      source = `
        const RD = globalThis.__stacyPluginBridge__?.reactDom;
        export default RD;
    ...
    case "sdk-ui":
      source = `
        const SDK = globalThis.__stacyPluginBridge__?.sdkUi ?? {};
 ...
 * - `import { ... } from "@arpanstacy/stacy-plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@arpanstacy/stacy-plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@arpanstacy/stacy-plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@arpanstacy/stacy-plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@arpanstacy/stacy-plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
...
async function importPluginModule(url: string): Promise<Record<string, unknown>> {
  ...
  if (!globalThis.__stacyPluginBridge__) {
 ...
 * self-register via `window.stacyPlugins.registerReactComponent()`.
 ...
 * of `@arpanstacy/stacy-plugin-sdk/ui`, `react`, and `react-dom` resolve to the
