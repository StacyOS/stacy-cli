 ...
 *
 * This is placed on `globalThis.__stacyPluginBridge__` and consumed by
...
declare global {
  ...
  var __stacyPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__stacyPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__stacyPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
