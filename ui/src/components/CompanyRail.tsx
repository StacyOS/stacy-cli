...
import type { Company } from "@arpanstacy/stacy-shared";
...
export function CompanyRail() {
  ...
  return (
    <div className="flex flex-col items-center w-[72px] shrink-0 h-full bg-background border-r border-border">
      {/* Stacy mark - aligned with top sections (implied line, no visible border) */}
      <div className="flex items-center justify-center h-12 w-full shrink-0">
        <div
          className="flex size-8 items-center justify-center bg-primary font-serif text-[22px] leading-none text-primary-foreground [clip-path:polygon(0_0,calc(100%_-_7px)_0,100%_7px,100%_100%,7px_100%,0_calc(100%_-_7px))]"
          aria-label="Stacy"
        >
          S
        </div>
