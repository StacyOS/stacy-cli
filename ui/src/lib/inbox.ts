...
export const DISMISSED_KEY = "stacy:inbox:dismissed";
export const READ_ITEMS_KEY = "stacy:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "stacy:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "stacy:inbox:issue-columns";
export const INBOX_NESTING_KEY = "stacy:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "stacy:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "stacy:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "stacy:inbox:collapsed-groups";
