...
export interface StacyIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface StacyIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: StacyIssueRuntimeReassignment;
}

interface UseStacyIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: StacyIssueRuntimeSendOptions) => Promise<void>;
...
export function useStacyIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseStacyIssueRuntimeOptions) {
