...
- [ ] The first paragraph points at the Stacy skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Stacy execution contract verbatim:
...
- [ ] Adapter config matches this Stacy instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
