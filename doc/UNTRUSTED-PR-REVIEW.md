...
This is intentionally separate from the normal Stacy dev image.
...
```sh
review-checkout-pr StacyOS/stacy-cli 432
cd /work/checkouts/stacy-stacy/pr-432
```
...
## Preview the Stacy app from the PR
...
- Stacy's embedded PostgreSQL and local storage stay inside the container home volume via `STACY_HOME=/home/reviewer/.stacy-review`.
