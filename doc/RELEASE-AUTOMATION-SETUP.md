...
This document covers the GitHub and npm setup required for the current Stacy release model:
...
Do this for every public package that Stacy publishes.
...
3. add a trusted publisher for the GitHub repository `StacyOS/stacy-cli`
...
2. revoke any personal automation token that used to publish Stacy
