...
- installed adapter list for this Stacy instance
...
## 8. New Skill: `stacy-create-agent`

Create new skill directory:

- `skills/stacy-create-agent/SKILL.md`
- `skills/stacy-create-agent/references/api-reference.md`
...
Also update `skills/stacy/SKILL.md` to reference this skill for hiring workflows.
...
- `stacy-create-agent` skill + docs updates
