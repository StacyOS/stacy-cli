...
Stacy already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Stacy should implement next.

## Product Goals

Stacy should let operators:
...
For the next implementation pass, Stacy should enforce these defaults:
...
Stacy should separate subscription-included usage from billed spend:
...
Stacy should have two threshold classes:
...
Stacy must know that a project is budget-paused and enforce it.
...
Stacy must also block execution before new work starts.
