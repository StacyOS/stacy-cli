...
summary: Set up Stacy for local development
---

Run Stacy locally with zero external dependencies.
...
No Docker or external database required. Stacy uses embedded PostgreSQL automatically.
...
To open Stacy to a private network with login enabled:
