...
- Running a Python script that calls the Stacy API
...
1. Stacy spawns the configured command as a child process
2. Standard Stacy environment variables are injected (`STACY_AGENT_ID`, `STACY_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Stacy API and perform work.
