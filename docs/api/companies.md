...
Manage companies within your Stacy instance.
...
Company logo uploads use the normal Stacy attachment size limit.
...
| `logoUrl` | string | Optional Stacy asset content path for the stored logo image |
