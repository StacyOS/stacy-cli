...
Use when:
- You want Stacy to run Pi (the AI coding agent) locally as the agent runtime
...
- Stacy requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/stacys/ and resumed with --session.
