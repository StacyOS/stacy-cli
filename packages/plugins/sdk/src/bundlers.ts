/**
 * Bundling presets for Stacy plugins.
 *
 ...
 * to match the Stacy plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@arpanstacy/stacy-plugin-sdk/ui",
    "@arpanstacy/stacy-plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const rollupManifest: RollupLikeConfig = {
    ...
    external: ["@arpanstacy/stacy-plugin-sdk"],
  };
