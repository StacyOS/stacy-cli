/**
 * `@arpanstacy/stacy-plugin-sdk` — Stacy plugin worker-side SDK.
 *
 * This is the main entrypoint for plugin worker code.  For plugin UI bundles,
 * import from `@arpanstacy/stacy-plugin-sdk/ui` instead.
 *
 * @example
 * ```ts
 * // Plugin worker entrypoint (dist/worker.ts)
 * import { definePlugin, runWorker, z } from "@arpanstacy/stacy-plugin-sdk";
 *
...
// Manifest and constant types re-exported from @arpanstacy/stacy-shared
// Plugin authors import manifest types from here so they have a single
// dependency (@arpanstacy/stacy-plugin-sdk) for all plugin authoring needs.
export type {
 ...
 * @example
 * ```ts
 * import { z } from "@arpanstacy/stacy-plugin-sdk";
 *
