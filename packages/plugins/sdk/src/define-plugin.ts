/**
 * `definePlugin` — the top-level helper for authoring a Stacy plugin.
 *
...
// ---------------------------------------------------------------------------
// StacyPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `StacyPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@arpanstacy/stacy-plugin-sdk";
