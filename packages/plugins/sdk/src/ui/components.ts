 ...
 *
 * These components are exported from `@arpanstacy/stacy-plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@arpanstacy/stacy-plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function StacySdkUiComponent(props: TProps) {
