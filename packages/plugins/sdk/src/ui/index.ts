/**
 * `@arpanstacy/stacy-plugin-sdk/ui` — Stacy plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@arpanstacy/stacy-plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@arpanstacy/stacy-plugin-sdk/ui";
 *
