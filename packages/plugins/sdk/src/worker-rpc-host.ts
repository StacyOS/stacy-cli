...
import type { StacyPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@arpanstacy/stacy-plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: StacyPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@arpanstacy/stacy-shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
