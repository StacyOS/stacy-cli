 ...
 * channel.
 *
 * The Stacy plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@arpanstacy/stacy-shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Stacy messages.
 */
...
/**
 * Stacy plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Stacy instance. */
    instanceId: string;
    /** Semver version of the running Stacy host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
