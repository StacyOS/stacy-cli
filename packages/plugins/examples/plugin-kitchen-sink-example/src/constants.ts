import type { PluginLauncherRegistration } from "@arpanstacy/stacy-plugin-sdk";

export const PLUGIN_ID = "stacy-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".stacy-kitchen-sink-demo.txt",
} as const;
