...
const manifest: StacyPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Stacy plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Stacy",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Stacy domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
