...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within StacyPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Stacy host.
 *
...
export interface StacyPluginManifestV1 {
   ...
   */
  minimumStacyVersion?: PluginMinimumHostVersion;
