CREATE TABLE IF NOT EXISTS "feedback_exports" (
	...
	"schema_version" text DEFAULT 'stacy-feedback-envelope-v2' NOT NULL,
	"bundle_version" text DEFAULT 'stacy-feedback-bundle-v2' NOT NULL,
	"payload_version" text DEFAULT 'stacy-feedback-v1' NOT NULL,
	"payload_digest" text,
