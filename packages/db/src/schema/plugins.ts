...
import type { PluginCategory, PluginStatus, StacyPluginManifestV1 } from "@arpanstacy/stacy-shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<StacyPluginManifestV1>().notNull(),
